...
let CheckoutComponent = class CheckoutComponent {
    constructor(produtoService, loginService) {
    ...
    vender() {
        ...
        this.loginService.testeCliente.subscribe((mostrar) => this.testeCliente = mostrar);
    }
};
...
let LoginService = class LoginService {
    ...
    checar(cpf, email) {
        this.http.get("api/user/" + cpf + "/" + email).subscribe((retorno) => {
            console.log(retorno);
            if (retorno == 200) {
