...
var PostProdutosService = /** @class */ (function () {
        ...
        this.http.get("/api/").subscribe(function (posts) {
            ...
            try {
                for (var posts_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](posts), posts_1_1 = posts_1.next(); !posts_1_1.done; posts_1_1 = posts_1.next()) {
                    ...
                    _this.postsProduto.push(new _postProduto__WEBPACK_IMPORTED_MODULE_3__["PostProduto"](p.nome, p.preco, p.detalhes, p.modelo, p.material, p.lavagem, p.arquivo, p.id));
                }
            }
    ...
    PostProdutosService.prototype.buscar = function (id) {
        var _this = this;
        this.postProduto.splice(0);
        this.http.get("/api/produto/" + id).subscribe(function (p) {
            _this.postProduto.push(new _postProduto__WEBPACK_IMPORTED_MODULE_3__["PostProduto"](p.nome, p.preco, p.detalhes, p.modelo, p.material, p.lavagem, p.arquivo, p.id));
        });
    };
